...
class SubDataset(object):
    ...
    def get_image_anno(self, video, track, frame):
        ...
        # if "LaSOT" in self.root:
        #     class_name = video.split('-')[0]
        #     video1 = class_name + '/' + video
...
class BANDataset(Dataset):
    ...
    def _get_bbox(self, image, shape, imagepath):
        try:
    ...
    def __getitem__(self, index):
        ...
        # get bounding box
        template_box = self._get_bbox(template_image, template[1], template[0])
        search_box = self._get_bbox(search_image, search[1], search[0])
