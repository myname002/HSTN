...
lasot = json.load(open('/raid/huangl03/lixiaojing/Dimp/LaSOT/lasotnocup.json', 'r'))
...
with open(join('/raid/huangl03/lixiaojing/SiamBan/siamban-master/training_dataset/lasot/LaSOT/testing_set.txt')) as f:
...
json.dump(train_snippets, open('/raid/huangl03/lixiaojing/Dimp/LaSOT/trainnocup.json', 'w'), indent=4, sort_keys=True)
json.dump(val_snippets, open('/raid/huangl03/lixiaojing/Dimp/LaSOT/val.json', 'w'), indent=4, sort_keys=True)
