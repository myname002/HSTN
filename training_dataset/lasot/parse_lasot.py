...
parser.add_argument('--dir',type=str, default='/raid/huangl03/lixiaojing/Dimp/LaSOT/LaSOTbenchmark', help='your lasot data dir')
...
json.dump(lasot, open('/raid/huangl03/lixiaojing/Dimp/LaSOT/lasotnocup.json', 'w'), indent=4, sort_keys=True)
