...
parser.add_argument('--dir', type=str, default='/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data', help='your got_10k data dir')
...
json.dump(got10k, open('/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data/got10k.json', 'w'), indent=4, sort_keys=True)
