...
got10k = json.load(open('/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data/got10k-SiamBan.json', 'r'))
...
json.dump(train, open('/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data/train.json', 'w'), indent=4, sort_keys=True)
json.dump(val, open('/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data/val.json', 'w'), indent=4, sort_keys=True)
