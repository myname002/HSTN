...
got10k_base_path = '/raid/huangl03/lixiaojing/Dimp/GOT-10k/full_data'
sub_sets = sorted({'train_data'}) # 'train_data',
...
def main(instanc_size=511, num_threads=24):
    crop_path = '/raid/huangl03/lixiaojing/Dimp/Crop/GOT-10k/crop{:d}'.format(instanc_size)
